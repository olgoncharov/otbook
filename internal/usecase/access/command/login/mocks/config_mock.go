...
//go:generate minimock -i github.com/olgoncharov/otbook/internal/usecase/access/command/login.config -o ./internal/usecase/access/command/login/mocks/config_mock.go -n ConfigMock
...
// ConfigMock implements login.config
...
// NewConfigMock returns a mock for login.config
...
// JWTRefreshTokenTTL implements login.config
