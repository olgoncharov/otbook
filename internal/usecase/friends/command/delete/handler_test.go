...
import (
	...
	"github.com/olgoncharov/otbook/internal/usecase/friends/command/delete/mocks"
...
func TestHandler_Handle(t *testing.T) {
	...
	t.Run("friends repo returns error", func(t *testing.T) {
		...
		h.friendsRepoMock.DeleteFriendMock.Expect(ctx, username1, username2).Return(assert.AnError)
